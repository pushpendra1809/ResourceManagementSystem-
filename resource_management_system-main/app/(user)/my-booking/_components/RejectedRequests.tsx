...
const RejectedRequests = ({
  ...
  rejectedRequests: RequestModelType[];
  setRejectedRequests: React.Dispatch<React.SetStateAction<RequestModelType[]>>;
}) => {
  ...
  return (
    <div className="flex flex-col gap-3 overflow-auto h-[580px] mt-5">
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Are you sure you want to delete rjected booking request?
                    Once deleted, this action cannot be undone and the booking
